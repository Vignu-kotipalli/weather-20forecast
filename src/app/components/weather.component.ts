...
@Component({
  ...
  template: `
    <div
      ...
      class="min-h-screen transition-all duration-1000 ease-in-out"
    >
      <div class="container mx-auto px-4 py-8">
        <!-- Header -->
        <div class="text-center mb-8">
          <h1
            class="text-4xl md:text-6xl font-bold text-white mb-4 animate-fade-in"
          >
            Weather App
          </h1>
        ...
        <div *ngIf="error()" class="max-w-md mx-auto mb-8">
          <div
            class="bg-red-500/20 backdrop-blur-md border border-red-500/30 text-white px-4 py-3 rounded-lg animate-slide-in"
          >
        ...
        <div *ngIf="currentWeather()" class="max-w-4xl mx-auto">
          <div
            class="bg-white/10 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-8 border border-white/20 animate-slide-up"
          >
          ...
          <div
            *ngIf="forecast().length > 0"
            class="bg-white/10 backdrop-blur-md rounded-3xl p-6 md:p-8 border border-white/20 animate-slide-up"
          >
        ...
        <!-- Welcome Message -->
        <div
          *ngIf="!currentWeather() && !loading() && !error()"
          class="max-w-md mx-auto text-center"
        >
          <div
            class="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 animate-fade-in"
          >
            <svg
              class="w-16 h-16 text-white/60 mx-auto mb-4"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p class="text-white/80">
              Enter a city name to get started with current weather and forecast
              information.
            </p>
          </div>
        </div>
...
export class WeatherComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.error.set(
      "Demo mode - Configure your OpenWeatherMap API key for live data",
    );
  }
  ...
  searchWeather() {
    ...
    this.weatherService.getCurrentWeather(this.searchCity).subscribe({
      ...
      error: (error) => {
        ...
        this.error.set(
          "Using demo data - Configure your OpenWeatherMap API key for live data",
        );
      },
    });
  }
